...
#define RECIV_BR_Pin GPIO_PIN_5
#define RECIV_BR_GPIO_Port GPIOA
...
#define RECIV_BL_Pin GPIO_PIN_0
#define RECIV_BL_GPIO_Port GPIOB
#define RECIV_FL_Pin GPIO_PIN_1
#define RECIV_FL_GPIO_Port GPIOB
#define EMIT_BR_Pin GPIO_PIN_10
#define EMIT_BR_GPIO_Port GPIOB
#define EMIT_BL_Pin GPIO_PIN_11
#define EMIT_BL_GPIO_Port GPIOB
